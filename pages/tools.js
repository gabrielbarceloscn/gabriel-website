  ...
  return (
    <PageTransition>
      <VStack spacing={8}>
        <Section>
          <VStack>
            <Heading as="h1">Ferramentas</Heading>
            <Text
              fontSize={["xl", "2xl"]}
              ...
              textAlign="center"
            >
              Certeza que essa lista vai te apresentar alguma ferramenta legal, que te resolve algum problema. Confere aí.
            </Text>
          </VStack>
        </Section>
        <Section>
          ...
          >
            ...
            <TabPanels>
              ...
              <TabPanel px={0}>
                <SimpleGrid columns={[1, 2]} spacing={4} mt={8}>
                  {tools
                    .filter((t) => t.fields.Platform === "iOS")
                    .sort((x, y) => sorter(y.fields.ID, x.fields.ID))
                    .map((tool) => (
                      <ToolCard
                        key={tool.id}
              ...
              <TabPanel px={0}>
                <SimpleGrid columns={[1, 2]} spacing={4} mt={8}>
                  {tools
                    .filter((t) => t.fields.Platform === "Windows")
                    .sort((x, y) => sorter(y.fields.ID, x.fields.ID))
                    .map((tool) => (
                      <ToolCard
                        key={tool.id}
